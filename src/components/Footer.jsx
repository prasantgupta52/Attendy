        ...
        <div className="footp">
          <div className="valign">
            <div className="valignfo">
              &copy;&nbsp;Attendy&nbsp;&nbsp; made by PRASANT GUPTA
            </div>
            <div className="social">
              <a href="https://www.facebook.com/prasantgupta5247/" target="_blank" className='bisocial'>
              ...
              <a href="https://wa.me/917063341955" target="_blank" className='bisocial'>
              ...
              <a href="https://www.instagram.com/prasantgupta52/" target="_blank" className='bisocial'>
              ...
              <a href="https://www.linkedin.com/in/prasantgupta52/" target="_blank" className='bisocial'>
              ...
              <a href="https://github.com/prasantgupta52" target="_blank" className='bisocial'>
